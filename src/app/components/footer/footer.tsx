  ...
  return (
    ...
    <div className='  flex justify-between sm:flex-col'>
      <div className='flex flex-col'>
        <div className='flex items-center gap-[15px] sm:justify-center'>
          <Image src={logo} alt='logo' className='w-[34px] h-[34px]' />
          <p className='text-[16px] font-bold ml-[-8px]'>Little Learners</p>
        </div>
        <p className='text-[20px] sm:text-center sm:w-[100%] text-[#4c4c4d] font-medium w-[519px] leading-[25px] pt-[25px] pb-[50px]'>We believe in the power of play to foster creativity, problem-solving skills, and imagination.</p>
      ...
      <div className='flex justify-around w-full sm:flex-col sm:gap-[35px] sm:mt-[35px]'>
        <div className='sm:flex sm:justify-around'>
        <div className='flex flex-col gap-[6px]  sm:mr-[65px]'>
    ...
    <div className='flex justify-between sm:flex-col  sm:items-center sm:gap-[20px]'>
